import { CategoryModule } from "./modules/admin/inventory/category/category.module";
  ...
  // Admin routes
  {
    ...
    children: [
        ...
        children: [
          {
            path: "category",
            loadChildren: () =>
              import("./modules/admin/inventory/category/category.module").then(
                (m) => m.CategoryModule
              ),
          },
          {
            path: "products",
            loadChildren: () =>
              import("./modules/admin/inventory/product/product.module").then(
                (m) => m.ProductModule
              ),
          },
          {
            path: "addons",
            loadChildren: () =>
              import("./modules/admin/inventory/addons/addons.module").then(
                (m) => m.AddonsModule
              ),
          },
          {
            path: "noticeboard",
            loadChildren: () =>
              import("./modules/admin/notice-board/bulletin/notice.module").then(
          ...
          },
          {
            path: "reasons",
            loadChildren: () =>
              import("./modules/admin/reasons/reason.module").then(
                (m) => m.ReasonModule
              ),
          },
          {
            path: "promocode",
            loadChildren: () =>
              import("./modules/admin/promo-code/promo-code.module").then(
                (m) => m.PromoCodeModule
              ),
          },
          {
            ...
            loadChildren: () =>
              import("./modules/admin/dispute-manager/dispute-manager.module").then(
                (m) => m.DisputeManagerModule
              ),
          },
          {
            path: "cuisines",
            loadChildren: () =>
              import("./modules/admin/cuisines/cuisines.module").then(
                (m) => m.CuisinesModule
              ),
          },
        ],
      ...
      // Delivery People
      {
        ...
        loadChildren: () =>
          import("./modules/admin/delivery-agent/delivery-agent.module").then(
        ...
        children: [
          {
            ...
            loadChildren: () =>
              import(
                "./modules/admin/restaurant/restaurant-detail/restaurant-detail.module"
              ).then((m) => m.RestaurantDetailModule),
          },
          {
            path: "settings",
            loadChildren: () =>
              import(
                "./modules/admin/restaurant/settings/settings.module"
      ...
      // Apps TODO: Should remove this routes
      {
        path: "apps",
        children: [
          {
            path: "academy",
            loadChildren: () =>
              import("app/modules/admin/apps/academy/academy.module").then(
                (m) => m.AcademyModule
              ),
          },
          {
      ...
      // Pages TODO: Should remove this routes
      {
        path: "pages",
        children: [
          // Activities
      ...
      // User interface TODO: Should remove this routes
      {
        path: "ui",
        children: [
          // Angular Material
      ...
      // Documentation TODO: Should remove this routes
      {
        path: "docs",
        children: [
          // Changelog
