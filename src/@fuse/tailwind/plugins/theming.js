                    ...
                    customProps: {
                        background: {
                            light: {
                                'bg-app-bar'   : '#FFFFFF',
                                'bg-card'      : '#FFFFFF',
                                'bg-default'   : colors.coolGray[100],
                                'bg-dialog'    : '#FFFFFF',
                                'bg-hover'     : chroma(colors.coolGray[400]).alpha(0.12).css(),
                                'bg-status-bar': colors.coolGray[300]
                            },
                            dark : {
                                'bg-app-bar'   : colors.coolGray[900],
                                'bg-card'      : colors.coolGray[800],
                                'bg-default'   : colors.coolGray[900],
                                'bg-dialog'    : colors.coolGray[800],
                                'bg-hover'     : 'rgba(255, 255, 255, 0.05)',
                                'bg-status-bar': colors.coolGray[900]
                            }
                        },
                        foreground: {
                            light: {
                                'text-default'  : colors.coolGray[800],
                                'text-secondary': colors.coolGray[500],
                                'text-hint'     : colors.coolGray[400],
                                'text-disabled' : colors.coolGray[400],
                                'border'        : colors.coolGray[200],
                                'divider'       : colors.coolGray[200],
                                'icon'          : colors.coolGray[500],
                                'mat-icon'      : colors.coolGray[500]
                            },
                            dark : {
                                'text-default'  : '#FFFFFF',
                                'text-secondary': colors.coolGray[400],
                                'text-hint'     : colors.coolGray[500],
                                'text-disabled' : colors.coolGray[600],
                                'border'        : chroma(colors.coolGray[100]).alpha(0.12).css(),
                                'divider'       : chroma(colors.coolGray[100]).alpha(0.12).css(),
                                'icon'          : colors.coolGray[400],
                                'mat-icon'      : colors.coolGray[400]
                            }
                        }
                    },
